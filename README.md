...
A Python-based voice AI assistant that controls smart home devices, orders food, and manages your Google Calendar via voice commands. Powered by Groq LLM, Sarvam Indian-English speech services, and deployed as a web app accessible from anywhere.
...
### 📋 Phase 4 — Movie Ticket Booking *(planned)*
